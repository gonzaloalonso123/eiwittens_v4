...
export const productTypes: ReadonlyArray<{ value: ProductType; label: string }> = [
...
export const productSubtypes: Readonly<Record<ProductType, ReadonlyArray<{ value: string; label: string }>>> = {
...
export const discountTypes: ReadonlyArray<{ value: DiscountType; label: string }> = [
...
export const actionTypes: ReadonlyArray<{ value: ActionType; label: string }> = [
